    ...
    return (
        <div className="one-publication-box">
            <div className="one-publication-intro">
                <h2 className="one-publication-title">{props.publication.title} at <a href={props.publication.PublicationWebsite} target="_blank">{props.publication.PublicationLocation}</a></h2>
            </div>
            <div>
